# MUSUBI for Qwen Code

**Ultimate Specification Driven Development**

This project uses **MUSUBI** (Ultimate Specification Driven Development) configured for Qwen Code.
...
Qwen Code uses commands in `.qwen/commands/`:
