...
| ------- | -------- | ---------- | ---------------------- |
| 1.0     | 2025-11-23 | [Author] | Initial task breakdown |
...
**Requirements Coverage**:
- REQ-test-tasks-001 (indirectly - foundation for implementation)
...
### TASK-002: Write Tests for REQ-test-tasks-001
...
**Description**:
Write failing tests for REQ-test-tasks-001 (Test-First / Red phase).

**Requirements Coverage**:

- REQ-test-tasks-001: [Requirement title]

**Acceptance Criteria**:

- [ ] Test file created: `lib/{{component}}/tests/service.test.ts`
- [ ] All acceptance criteria from REQ-test-tasks-001 have tests
- [ ] Tests fail (Red phase)
- [ ] Tests reference requirement ID in description
- [ ] Git commit message: `test: add failing tests for REQ-test-tasks-001`
...
describe('REQ-test-tasks-001: [Requirement title]', () => {
  it('should [acceptance criterion 1]', async () => {
    // Arrange
    const service = new test-tasksService(mockRepository);
...
### TASK-003: Implement test-tasks Service (REQ-test-tasks-001)
...
**Description**:
Implement minimal test-tasks service to pass tests (Green phase).
...
- [ ] Git commit message: `feat: implement REQ-test-tasks-001`

**Constitutional Compliance**:

- ✅ **Article III**: Test-First (Green phase)
- ✅ **Article V**: Code comments reference REQ-test-tasks-001
...
export class test-tasksService {
  constructor(private repository: test-tasksRepository) {}

  /**
   * REQ-test-tasks-001: Create new {{resource}}
   */
...
### TASK-004: Refactor test-tasks Service
...
- REQ-test-tasks-004: Database schema
...
export class test-tasksRepository {
...
- REQ-test-tasks-001 (CLI exposure)
...
import { test-tasksService } from './src/service';
...
program
  ...
  .action(async (options) => {
    const service = new test-tasksService(repository);
...
- REQ-test-tasks-001: Create endpoint
- REQ-test-tasks-002: Get endpoint
- REQ-test-tasks-003: List endpoint
...
import { test-tasksService } from '@/lib/{{component}}';
...
- REQ-test-tasks-001 to REQ-test-tasks-005 (all requirements)
...
| --------------------- | -------- | -------------------------------------- | ------------- | ----------- |
| REQ-test-tasks-001 | P0       | TASK-002, TASK-003, TASK-004, TASK-007 | 95%           | Not Started |
| REQ-test-tasks-002 | P0       | TASK-007                               | 90%           | Not Started |
| REQ-test-tasks-003 | P0       | TASK-007                               | 90%           | Not Started |
| REQ-test-tasks-004 | P0       | TASK-005                               | 85%           | Not Started |
